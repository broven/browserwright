...
def test_build_workspace(tmp_path: Path):
    ...
    # .browser-skill/site-skills/ exists and is empty
...
def test_reset_workspace(tmp_path: Path):
    ...
    # Drop a file in .browser-skill
    junk = root / ".browser-skill" / "site-skills" / "junk.txt"
    ...
    assert list((root / ".browser-skill" / "site-skills").iterdir()) == []
