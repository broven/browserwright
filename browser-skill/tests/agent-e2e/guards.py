...
- Bash: single browser-skill / browser-daemon invocations (no shell injection)
...
async def pre_tool_use(
    ...
    if tool == "Bash":
        ...
        # Strip leading env var assignments (BD_PORT=9333 browser-skill ...)
        ...
        for line in shell_part.splitlines():
            ...
            if not line:
                continue
            # Strip leading env assignments (BD_PORT=9333 browser-skill ...)
