...
| 29990 | cdp Chrome `--remote-debugging-port` (`TEST_CDP_PORT`) |
| 29991 | L1 cdp facade daemon (`TEST_FACADE_L1_PORT`) |
| 29992 | L1 extension facade daemon (`TEST_FACADE_L1_EXT_PORT`) |
| 29993 | session extension daemon facade (`TEST_FACADE_EXT_PORT`) |
| 29994 | session cdp daemon facade (`TEST_FACADE_CDP_PORT`) |
| (new) | cdp auto-facade daemon facade (`TEST_FACADE_AUTOFACADE_PORT`) |
...
| daemon CDP port | default | per-worktree derived |
