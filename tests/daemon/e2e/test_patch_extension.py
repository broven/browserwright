...
def test_patch_extension_missing_source_raises(tmp_path):
    with pytest.raises(FileNotFoundError):
        patch_extension_dir(tmp_path / "does-not-exist", relay_port=TEST_EXT_PORT)
