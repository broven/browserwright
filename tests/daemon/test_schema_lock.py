...
from browserwright.daemon.backends import base
from browserwright.daemon import doctor as doctor_mod
...
@pytest.mark.asyncio
async def test_browserwright_daemon_dispatch_uses_v2_lockable_methods_only(monkeypatch):
