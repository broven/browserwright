...
from browser_daemon.observability import (
...
def test_json_log_formatter_emits_valid_json_with_schema():
    ...
    record = logging.LogRecord(
        name="browser_daemon.test", level=logging.INFO,
    ...
    assert payload["logger"] == "browser_daemon.test"
...
@pytest.mark.asyncio
async def test_browser_daemon_stats_method_returns_snapshot(
