"""L2 -- multiple browser-skill sessions through extension backend.

This exercises the real extension-backed path: a real Chrome extension is
connected to the test daemon, then two independent browser-skill Session
...
from browser_skill import close_tab, js, open_background, wait_for_load
from browser_skill.session import Session, with_session
from browser_skill.session_ctx import resolve_session

# browser-skill inline requires an explicit ledger session. run_skill() injects
