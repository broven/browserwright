...
``selftest_cache.json`` health record across all bundled / discovered tasks::
    ...
    browserwright selftest run                  # every task across all sites
    browserwright selftest run --site github.com
    browserwright selftest run --json           # machine-readable summary
