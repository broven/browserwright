...
| `mise run upgrade-global` | Sync global install to PyPI latest + matching extension artifact (dev fallback; production users install the extension from the Chrome Web Store — see [RELEASING.md](RELEASING.md)) |
